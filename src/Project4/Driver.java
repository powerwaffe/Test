...
public class Driver
{
    public static void main(String[] args)
    {
        System.out.println("Testing postfix expressions with\n" +
                "a = 2, b = 3, c = 4, d = 5, e = 6, f = 0, g = 1, h = 8\n\n");
        ...
        /** test new values */
        System.out.println("Testing NEW values!!\n");
        testPostfix("(a-f)");
        System.out.println("af- : " + Postfix.evaluatePostfix("af-\n"));
        testPostfix("(h*f)-a");
        System.out.println("hf*a- : " + Postfix.evaluatePostfix("hf*a-"));
    }  // end main
